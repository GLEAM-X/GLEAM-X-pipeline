...
usage()
{
echo "drift_prepnight.sh [-p project] [-d dep] [-q queue] [-a account] [-t] [-r ra] [-e dec] list_of_nights.txt
...
output="${GXLOG}/prepnight_${listbase}.o%A_%a"
error="${GXLOG}/prepnight_${listbase}.e%A_%a"
